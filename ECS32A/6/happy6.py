...
# if the population of a country is less than 100 million it is not included in the output.
...
def read_gdp_data(happy_dict):
    ...
    for lines in infile_2:
        ...
        #remove dollar sign
        GDP = GDP.strip('$')
        #find country in the dictionary and population greater than 100 million
        if country in happy_dict and float(population) > 100:
